...
namespace myos
{
    ...
    enum TaskPriority {HIGH, MED, LOW};
...
*/
    ...
    class Task
    {
        ...
        private:
            ...
            CPUState* cpustate;
            TaskPriority priority; // Add priorit attribute
        ...
        public:
            ...
            Task(GlobalDescriptorTable *gdt, void entrypoint(), TaskPriority pr);
    ...
    class TaskManager
    {
        ...
        public:
            ...
            CPUState* priorityScheduler(CPUState* cpustate);
    };
